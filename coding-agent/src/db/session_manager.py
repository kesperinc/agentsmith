...
def _resolve_db_path() -> str:
    if os.getenv("AGENTSMITH_DATA_DIR"):
        return os.path.join(os.getenv("AGENTSMITH_DATA_DIR"), "sessions.db")
    if os.getenv("AGENTSMITH_WORKSPACE_ROOT"):
        return os.path.join(os.getenv("AGENTSMITH_WORKSPACE_ROOT"), ".agentsmith", "sessions.db")
    return os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), ".agentsmith", "sessions.db")
